...
import { Package, Users, Shield, TrendingUp, DollarSign, ShoppingCart } from "lucide-react"
...
export default function AdminDashboard() {
  ...
  const fetchStats = async () => {
    try {
      ...
      const [{ count: packsCount }, { count: usersCount }, { count: appealsCount }] = await Promise.all([
      ...
      // Calculate from actual purchase data only
