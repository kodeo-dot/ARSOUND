...
import { Download, ArrowLeft, Check, X, AlertCircle, Scale, Shield, FileText } from "lucide-react"
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-5xl py-12 px-4">
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 text-sm text-muted-foreground px-4 py-2 bg-muted/50 rounded-full">
            <FileText className="h-4 w-4" />
            Versión {LICENSE_CONFIG.version} • {LICENSE_CONFIG.lastUpdated}
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-card border border-border rounded-2xl p-6 hover:shadow-lg transition-shadow">
            ...
            <ul className="space-y-3 text-sm text-foreground">
              ...
              <li className="flex items-start gap-3">
                <Check className="h-4 w-4 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                <span>Sin necesidad de créditos</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-6 hover:shadow-lg transition-shadow">
            ...
            <ul className="space-y-3 text-sm text-foreground">
              ...
              <li className="flex items-start gap-3">
                <X className="h-4 w-4 text-red-600 dark:text-red-400 mt-0.5 flex-shrink-0" />
                <span>Registrar en Content ID</span>
              </li>
              <li className="flex items-start gap-3">
                <X className="h-4 w-4 text-red-600 dark:text-red-400 mt-0.5 flex-shrink-0" />
                <span>Incluir en otros packs</span>
              </li>
              <li className="flex items-start gap-3">
                <X className="h-4 w-4 text-red-600 dark:text-red-400 mt-0.5 flex-shrink-0" />
                <span>Reclamar autoría exclusiva</span>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-2xl p-8 mb-8">
          ...
          <div className="prose prose-sm dark:prose-invert max-w-none">
            <div className="whitespace-pre-wrap leading-relaxed text-foreground/90 bg-background/50 p-6 rounded-xl border border-border/50 backdrop-blur-sm">
              {LICENSE_SUMMARY}
            </div>
          </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-border">
            ...
            <h2 className="text-2xl font-black text-foreground">Términos Completos</h2>
          </div>
          <div className="prose prose-sm dark:prose-invert max-w-none">
        ...
        <div className="mt-8 p-6 bg-amber-500/10 border border-amber-500/30 rounded-2xl">
          <div className="flex gap-4">
            <div className="p-2.5 bg-amber-500/20 rounded-xl h-fit flex-shrink-0">
              <AlertCircle className="h-5 w-5 text-amber-600 dark:text-amber-500" />
            </div>
            <div>
              <p className="font-black text-amber-600 dark:text-amber-500 mb-2">Aviso Legal</p>
