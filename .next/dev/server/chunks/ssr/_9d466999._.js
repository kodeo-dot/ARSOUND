...
async function selectPlan(planId) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            console.error("[v0] Mercado Pago API response (raw):", text);
            throw new Error("Error creating payment preference");
        }
        const data = JSON.parse(text);
        if (data.init_point) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])(data.init_point);
        }
        return {
            success: true,
...
async function purchasePack(packId, discountCode) {
    ...
    try {
        ...
        ;
        if (!response.ok) {
            console.error("[v0] Mercado Pago API response:", text);
            throw new Error("Error creating payment preference");
        }
        const data = JSON.parse(text);
        if (data.init_point) {
...
//# sourceMappingURL=_9d466999._.js.map